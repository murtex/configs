...
" Last Change:  $Id: erfurt.vim,v 2.21 2011/04/26 12:13:41 slinky Exp slinky $
" URL:          http://slinky.imukuppi.org/erfurtpage/
...
"
" After installation, use it with :colorscheme erfurt.
" See also :help syntax
"
" Credits:
"  - Jani Nurminen - original erfurt, maintainer
...
"  - Marcin Szamotulski - support autocomplete for erfurt configuration
"                         parameters
"  - Clayton Parker (claytron) - Convinced by Kurt Maier to use erfurt. Point
...
" set some parameters to tweak the erfurt colours.
"
...
"    colors erfurt
"
" You can also do ":let g:erfurt" then hit Ctrl-d or Tab to scroll through the
...
"   look strange.
"
"      let g:erfurt_color_also_Ignore = 1
"
" * To get more contrast to the Visual selection, use
"
"      let g:erfurt_alternate_Visual = 1
"
"   Note: this is enabled only if the old-style Visual
"   if used, see g:erfurt_old_Visual
"
" * To use alternate colouring for Error message, use
"
"      let g:erfurt_alternate_Error = 1
"
" * The new default for Include is a duller orange. To use the original
"   colouring for Include, use
"
"      let g:erfurt_alternate_Include = 1
"
" * Work-around to a Vim bug, it seems to misinterpret ctermfg and 234 and 237
"   as light values, and sets background to light for some people. If you have
"   this problem, use:
"
"      let g:erfurt_force_dark_Background = 1
"
...
"
"      let g:erfurt_unified_CursorColumn = 1
"
...
"
"      let g:erfurt_old_Visual = 1
"
"   Default is to use the new Visual.
"
"  * EXPERIMENTAL FEATURE: erfurt will automatically detect if you 
...
"
"    let g:erfurt_disable_ctags_highlighting_support = 1
"
" NOTE:
"
" * To turn the parameter(s) back to defaults, use UNLET or set them to 0:
"
"      unlet g:erfurt_alternate_Include
"   or 
"      let g:erfurt_alternate_Include = 0
"
"
" That's it, enjoy!
"
...
if ! exists("g:erfurt_high_Contrast")
    let g:erfurt_high_Contrast = 0
endif

if ! exists("g:erfurt_color_also_Ignore")
    let g:erfurt_color_also_Ignore = 0
endif

if ! exists("g:erfurt_alternate_Error")
    let g:erfurt_alternate_Error = 0
endif

if ! exists("g:erfurt_force_dark_Background")
    let g:erfurt_force_dark_Background = 0
endif

if ! exists("g:erfurt_alternate_Visual")
    let g:erfurt_alternate_Visual = 0
endif

if ! exists("g:erfurt_alternate_Include")
    let g:erfurt_alternate_Include = 0
endif

if ! exists("g:erfurt_unified_CursorColumn")
    let g:erfurt_unified_CursorColumn = 0
endif

if ! exists("g:erfurt_old_Visual")
    let g:erfurt_old_Visual = 0
endif

if ! exists("g:erfurt_disable_ctags_highlighting_support")
    " enabled by default
    let g:erfurt_disable_ctags_highlighting_support = 0
endif
...
let g:colors_name="erfurt"

" check for ctags-highlighting
if exists("g:loaded_ctags_highlighting") && g:loaded_ctags_highlighting && ! g:erfurt_disable_ctags_highlighting_support
    " internal
    let _erfurt_ctags = 1
endif
...
hi SpellBad   guisp=#bc6c4c guifg=#dc8c6c gui=bold
hi SpellCap   guisp=#6c6c9c guifg=#8c8cbc gui=bold
hi SpellRare  guisp=#bc6c9c guifg=#bc8cbc gui=bold
hi SpellLocal guisp=#7cac7c guifg=#9ccc9c gui=bold
...
if &t_Co > 255
    ...
    hi DiffText        ctermfg=52   ctermbg=242     cterm=bold
	...
	hi SpellLocal ctermfg=14  ctermbg=237 cterm=bold
	hi SpellBad   ctermfg=9   ctermbg=237 cterm=bold
	hi SpellCap   ctermfg=12  ctermbg=237 cterm=bold
	hi SpellRare  ctermfg=13  ctermbg=237 cterm=bold

    " pmenu
    hi PMenu      ctermfg=248  ctermbg=0
    hi PMenuSel   ctermfg=223 ctermbg=235

    if exists("g:erfurt_high_Contrast") && g:erfurt_high_Contrast
        hi Normal ctermfg=188 ctermbg=234
        hi NonText         ctermfg=238

        if exists("g:erfurt_color_also_Ignore") && g:erfurt_color_also_Ignore
        ...
        if exists("g:erfurt_unified_CursorColumn") && g:erfurt_unified_CursorColumn
    ...
    if exists("g:erfurt_alternate_Error") && g:erfurt_alternate_Error
        " use more jumpy Error
        hi Error ctermfg=210 ctermbg=52 gui=bold
    else
        " default is something more erfurt-compatible
        hi Error ctermfg=228 ctermbg=95 gui=bold
    endif
endif

if exists("g:erfurt_force_dark_Background") && g:erfurt_force_dark_Background
...
if exists("g:erfurt_old_Visual") && g:erfurt_old_Visual
    if exists("g:erfurt_alternate_Visual") && g:erfurt_alternate_Visual
...
if exists("g:erfurt_alternate_Include") && g:erfurt_alternate_Include
    " original setting
...
if exists("g:erfurt_high_Contrast") && g:erfurt_high_Contrast
    ...
    if &t_Co > 255
        hi FoldColumn    ctermbg=235 ctermfg=109
