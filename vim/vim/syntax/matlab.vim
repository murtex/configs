...
syn keyword matlabTodo			contained  TODO NOTE FIXME XXX DEBUG TEST
...
"Numeric Types
syn keyword matlabFunc 			arrayfun cast cat class find intmax intmin intwarning ipermute isa isequal isequalwithequalnans isfinite isinf isnan isnumeric isreal isscalar isvector iscolumn isrow ismatrix permute realmax realmin reshape squeeze zeros
...
syn keyword matlabFunc blkdiag diag eye freqspace ind2sub linspace logspace meshgrid ndgrid ones rand randn randi sub2ind 
"Array Operations
...
"Audio and Video
syn keyword matlabFunc wavread wavwrite
